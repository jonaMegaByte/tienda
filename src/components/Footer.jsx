  ...
  return (
    <footer>
      <div className="Footer-contact">
        ...
        <p className="Footer-description">Estamos para ayudarte todos los días de 8am a 5pm</p>
      </div>
      <div>
        ...
        <details className="Footer-info">
          ...
          <ul>
            ...
            <li className="Footer-info--list-item">Correo: megabyte9703@gmail.com</li>
          </ul>
        </details>
      </div>
      <div className="Footer-media">
        <a href="https://www.facebook.com/M-y-M-R%C3%BAsticos-106893704540172" className="Footer-link">
